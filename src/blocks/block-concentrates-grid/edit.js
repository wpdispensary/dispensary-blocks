...
export default withSelect( ( select, props ) => {
	...
	const latestProductsQuery = pickBy( {
		concentrates_category: categories,
		order,
		orderby: orderBy,
	...
	return {
		latestProducts: getEntityRecords( 'postType', 'concentrates', latestProductsQuery ),
		categoriesList: getEntityRecords( 'taxonomy', 'concentrates_category', categoriesListQuery ),
	};
} )( WPDProductsBlock );