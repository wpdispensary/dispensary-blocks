...
export default withSelect( ( select, props ) => {
	...
	return {
		latestProducts: getEntityRecords( 'postType', 'gear', latestProductsQuery ),
		categoriesList: getEntityRecords( 'taxonomy', 'wpd_gear_category', categoriesListQuery ),
	};
} )( WPDProductsBlock );