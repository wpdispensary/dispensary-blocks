...
export default withSelect( ( select, props ) => {
	...
	return {
		latestProducts: getEntityRecords( 'postType', 'edibles', latestProductsQuery ),
		categoriesList: getEntityRecords( 'taxonomy', 'edibles_category', categoriesListQuery ),
	};
} )( WPDProductsBlock );