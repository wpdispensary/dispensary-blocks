 ...
 */
function dispensary_blocks_render_block_core_latest_products( $attributes ) {
		...
		foreach ( $recent_products as $product ) {
			...
			$list_items_markup .= sprintf(
				...
				$list_items_markup .= sprintf(
					...
					$product_details = apply_filters( 'wpd_flowers_block_product_details', $product_details );
 ...
 */
function dispensary_blocks_register_block_core_latest_products() {
	...
	register_block_type( 'dispensary-blocks/wpd-flowers-grid', array(
		'attributes' => array(
			'categories' => array(
				'type' => 'string',
			),
		...
		'render_callback' => 'dispensary_blocks_render_block_core_latest_products',
	) );
}

add_action( 'init', 'dispensary_blocks_register_block_core_latest_products' );
