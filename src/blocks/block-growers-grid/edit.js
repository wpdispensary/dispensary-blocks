...
export default withSelect( ( select, props ) => {
	...
	return {
		latestProducts: getEntityRecords( 'postType', 'growers', latestProductsQuery ),
		categoriesList: getEntityRecords( 'taxonomy', 'growers_category', categoriesListQuery ),
	};
} )( WPDProductsBlock );