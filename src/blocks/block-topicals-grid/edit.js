...
export default withSelect( ( select, props ) => {
	...
	return {
		latestProducts: getEntityRecords( 'postType', 'topicals', latestProductsQuery ),
		categoriesList: getEntityRecords( 'taxonomy', 'topicals_category', categoriesListQuery ),
	};
} )( WPDProductsBlock );